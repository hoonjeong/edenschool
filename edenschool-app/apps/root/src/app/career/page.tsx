...
export default function CareerHomePage() {
  return (
    <CareerShell title="이든 진로탐색 도우미" desc="어떤 진로를 선택하든 국어 역량이 필요하다는 것을 공공 데이터로 확인해 보세요.">
      <div className="career-eden-box">
        <strong>이든 진로탐색 도우미</strong>는 커리어넷(한국직업능력연구원)의 학과·직업·심리검사 데이터를 <strong>국어 과목과 국어 역량</strong>에 연결해 보여 줍니다.
